  ...
  <body>
    ...
    <div class="conteudo">
        <div class="links-superiores">
            <a href="${cp}/formularios/genero/novo.jsp" class="btn-principal">
                Cadastrar Gênero
            </a>
        ...
        <div class="tabela-container">
            <table class="tabelaListagem">
                ...
                <tbody>
                    ...
                    <c:forEach items="${servicos.getTodos()}" var="genero">
                        <tr>
                            <td>${genero.id}</td>
                            <td>${genero.descricao}</td>
                            <td>
                                <a href="${cp}/${prefixo}Alteracao&id=${genero.id}" class="btn-acao btn-principal">
                                    Alterar
                                </a>
                            </td>
                            <td>
                                <a href="${cp}/${prefixo}Exclusao&id=${genero.id}" class="btn-acao btn-principal">
                                    Excluir
                                </a>
                            </td>
                        </tr>
