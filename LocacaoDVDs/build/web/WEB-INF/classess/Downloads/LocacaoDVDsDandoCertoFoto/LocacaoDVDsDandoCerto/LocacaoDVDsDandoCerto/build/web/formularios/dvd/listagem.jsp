...
<body>
    ...
    <div class="conteudo">
        ...
        <div class="tabela-container">
            ...
            <c:if test="${empty servicos.todos && empty errorMessage}">
            ...
            <div class="catalog-grid">
                ...
                <c:forEach items="${servicos.todos}" var="dvd">
                    <div class="movie-card">
                        ...
                        <img src="${dvd.urlCartaz}" 
                             alt="Cartaz do filme ${dvd.titulo}" 
                             onerror="this.onerror=null;this.src='${cp}/img/poster-placeholder.png';">
